...
![](assets/git%20rebase简介(基本篇)/file-20251121112816280.png)
...
![](assets/git%20rebase简介(基本篇)/file-20251121112850688.png)

在这里，你可以用 "pull" 命令把 "origin" 分支上的修改拉下来并且和你的修改合并； 结果看起来就像一个新的 " 合并的提交 "(merge commit):

![](assets/git%20rebase简介(基本篇)/file-20251121112915573.png)
...
![](assets/git%20rebase简介(基本篇)/file-20251121113014241.png)/file-20251121113014241.png)
...
![](assets/git%20rebase简介(基本篇)/file-20251121113024973.png)

现在我们可以看一下用合并 (merge) 和用 rebase 所产生的历史的区别：

![](assets/git%20rebase简介(基本篇)/file-20251121113034515.png)
...
[gitcast:c7-rebase](https://gitbook.liuhui998.com/4_2 "GitCast #7: Rebasing")
