...
复制代码我们能看到这段代码创建了10个线程，每个线程循环1000次往StringBuilder对象里面append字符。正常情况下代码应该输出10000，但是实际运行会输出什么呢？

![0](https://note.youdao.com/yws/res/10688/22267562360147F59FEF0CC31D59A27C)
...
![0](https://note.youdao.com/yws/res/10689/3153A6ABC6CA4C26AA92ADE69482EFB5)

假设现在有两个线程同时执行了StringBuilder的append()方法，两个线程都执行完了第五行的ensureCapacityInternal()方法，此刻count=5。

![0](https://note.youdao.com/yws/res/10687/35F38659CAA04145A184EC4468809FD4)

这个时候线程1的cpu时间片用完了，线程2继续执行。线程2执行完整个append()方法后count变成6了

![0](https://note.youdao.com/yws/res/10692/B82EAF6EF193454C8FE68CE8203BBF98)
...
![0](https://note.youdao.com/yws/res/10686/E53BE478AA4741BFA89D822DCC455E82)
