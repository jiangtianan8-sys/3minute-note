本文首发于[并发网](http://ifeve.com/java-atomic/)，作者：方腾飞
...
- JDK1.6源码
- [JDK1.6API文档](http://dlc.sun.com.edgesuite.net/jdk/jdk-api-localizations/jdk-api-zh-cn/publish/1.6.0/html/zh_CN/api/)
- [Unsafe源码](http://www.docjar.com/html/api/sun/misc/Unsafe.java.html)