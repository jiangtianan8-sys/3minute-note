...
[一、Socket通信基本示例](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q1)

[二、消息通信优化](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2)

- [2.1 双向通信，发送消息并接受消息](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.1)
- [2.2 使用场景](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.2)
- [2.3 如何告知对方已发送完命令](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.3)

- [2.3.1 通过Socket关闭](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.3.1)
- [2.3.2 通过Socket关闭输出流的方式](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.3.2)
- [2.3.3 通过约定符号](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.3.3)
- [2.3.4 通过指定长度](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q2.3.4)

[三、服务端优化](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q3)

- [3.1 服务端并发处理能力](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q3.1)
- [3.2 服务端其他属性](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q3.2)
- [3.3 性能再次提升](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q3.3)

[四、Socket的其它知识](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4)

- [4.1 客户端绑定端口](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.1)
- [4.2 读超时SO_TIMEOUT](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.2)
- [4.3 设置连接超时](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.3)
- [4.4 判断Socket是否可用](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.4)

- [4.4.1 自定义心跳包](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#p4.4.1)
- [4.4.2 通过发送紧急数据](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#p4.4.2)
- [4.4.3 真的需要判断连接断开吗](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#p4.4.3)

- [4.5 设置端口重用SO_REUSEADDR](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.5) 
- [4.6 设置关闭等待SO_LINGER](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.6)
- [4.7 设置发送延迟策略TCP_NODELAY](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.7)
- [4.8 设置输出输出缓冲区大小SO_RCVBUF/SO_SNDBUF](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.8)
- [4.9 设置保持连接存活SO_KEEPALIVE](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.9)
- [4.10 异常：java.net.SocketException: Connection reset by peer](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q4.10)

[五、关于Socket的理解](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5)

- [5.1 Socket和TCP/IP](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.1)
- [5.2 Socket和RMI](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.2)
- [5.3 DatagramSocket与Socket](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.3)
- [5.4 拆包和黏包](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.4)

- [5.4.1 黏包](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.4.1)
- [5.4.2 拆包](https://www.cnblogs.com/yiwangzhibujian/p/7107785.html#q5.4.2)

一、Socket通信基本示例

　　这种模式是基础，必须掌握，后期对Socket的优化都是在这个基础上的，也是为以后学习NIO做铺垫。

![0](https://note.youdao.com/yws/res/9154/85FB25FAA1994367B8ED5BFE097E2E75)
...
package yiwangzhibujian.waitreceive; import java.io.InputStream; import java.io.OutputStream; import java.net.Socket; public class SocketClient { public static void main(String args[]) throws Exception { // 要连接的服务端IP地址和端口 String host = "127.0.0.1"; int port = 55533; // 与服务端建立连接 Socket socket = new Socket(host, port); // 建立连接后获得输出流 OutputStream outputStream = socket.getOutputStream(); String message = "你好 yiwangzhibujian"; socket.getOutputStream().write(message.getBytes("UTF-8")); //通过shutdownOutput高速服务器已经发送完数据，后续只能接受数据 socket.shutdownOutput(); InputStream inputStream = socket.getInputStream(); byte[] bytes = new byte[1024]; int len; StringBuilder sb = new StringBuilder(); while ((len = inputStream.read(bytes)) != -1) { //注意指定编码格式，发送方和接收方一定要统一，建议使用UTF-8 sb.append(new String(bytes, 0, len,"UTF-8")); } System.out.println("get message from server: " + sb); inputStream.close(); outputStream.close(); socket.close(); } }
...
package yiwangzhibujian.multiserver; import java.io.IOException; import java.io.InputStream; import java.net.ServerSocket; import java.net.Socket; public class SocketServer { public static void main(String args[]) throws IOException { // 监听指定的端口 int port = 55533; ServerSocket server = new ServerSocket(port); // server将一直等待连接的到来 System.out.println("server将一直等待连接的到来"); while(true){ Socket socket = server.accept(); // 建立好连接后，从socket中获取输入流，并建立缓冲区进行读取 InputStream inputStream = socket.getInputStream(); byte[] bytes = new byte[1024]; int len; StringBuilder sb = new StringBuilder(); while ((len = inputStream.read(bytes)) != -1) { // 注意指定编码格式，发送方和接收方一定要统一，建议使用UTF-8 sb.append(new String(bytes, 0, len, "UTF-8")); } System.out.println("get message from client: " + sb); inputStream.close(); socket.close(); } } }
...
// 要连接的服务端IP地址和端口 String host = "localhost"; int port = 55533; // 与服务端建立连接 Socket socket = new Socket(); socket.bind(new InetSocketAddress(55534)); socket.connect(new InetSocketAddress(host, port));
...
//有一个连接中的socket Socket socket=... //要发送的数据 String data=""; try{ //发送心跳包或者紧急数据，来检测连接的可用性 }catch (Excetption e){ //打印日志，并重连Socket socket=new Socket(host,port); } socket.write(data);
...
//有一个连接中的socket Socket socket=... //要发送的数据 String data=""; try{ socket.write(data); }catch (Excetption e){ //打印日志，并重连Socket socket=new Socket(host,port); socket.write(data); }
...
　　最近在看《TCP/IP详解 卷1：协议》，关于TCP/IP我觉得讲解的非常详细，我做了点[摘抄](http://www.cnblogs.com/yiwangzhibujian/p/7103498.html)，可以大致看看，非常建议大家阅读下这本书。通常TCP/IP分为四层：

![0](https://note.youdao.com/yws/res/9156/9F2D4BA5131349A187E356CE0736C276)
...
![0](https://note.youdao.com/yws/res/9155/425D85FE262B47D9B890F478B2D0D4F0)

　　也就是上面说的主动关闭，FIN_WAIT_1，这样服务端就能得知客户端发送完消息，此时服务端可以选择关闭连接，也可以选择发送数据后关闭连接：

![0](https://note.youdao.com/yws/res/9153/3F36ADC3939F4A04B2AE8BC0D4497339)
...
int length=1024;//这个是读取的到数据长度，现假定1024 byte[] data=new byte[1024]; int readLength=0; while(readLengthint read = inputStream.read(data, readLength, length-readLength); readLength+=read; }
