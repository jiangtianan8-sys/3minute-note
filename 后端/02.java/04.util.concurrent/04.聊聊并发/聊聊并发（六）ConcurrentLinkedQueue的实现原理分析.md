...
![0](https://note.youdao.com/yws/res/4746/B2615B1236734717B1BD8DD4BEBB65D9)
...
![0](https://note.youdao.com/yws/res/4747/1EFB99E775BF4D5993472495784AFE00)
...
public boolean offer(E e) { if (e == null) throw new NullPointerException(); Node n = new Node(e); for (;;) { Node t = tail; if (t.casNext(null, n) && casTail(t, n)) { return true; } } }
...
![0](https://note.youdao.com/yws/res/4745/4D22F1A3D8A0452DAB2EB7DEFCA8C256)
