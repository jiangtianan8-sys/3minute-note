...
![0](https://note.youdao.com/yws/res/4715/DF919BF3CAA64E76A7DF8B10C712A569)
...
2. BlockingQueue bounded = new LinkedBlockingQueue(1024);
...
![0](https://note.youdao.com/yws/res/4712/0E45C6736ECE4C98888DA1397808146E)
...
1. BlockingDeque deque = new LinkedBlockingDeque();
...
1. ConcurrentMap concurrentMap = new ConcurrentHashMap();

2. concurrentMap.put("key", "value");

3. Object value = concurrentMap.get("key");

4. 并发导航映射 ConcurrentNavigableMap
...
2. Waiter waiter = new Waiter(latch);
3. Decrementer decrementer = new Decrementer(latch);

4. new Thread(waiter) .start();
5. new Thread(decrementer).start();

6. Thread.sleep(4000);

7. public class Waiter implements Runnable{

8. CountDownLatch latch = null;

9. public Waiter(CountDownLatch latch) {
10. this.latch = latch;
11. }
...
18. System.out.println("Waiter Released");
19. }
20. }

21. public class Decrementer implements Runnable {

22. CountDownLatch latch = null;

23. public Decrementer(CountDownLatch latch) {
24. this.latch = latch;
25. }
...
![0](https://note.youdao.com/yws/res/4708/6658B34BC68743838544E06F3D921B8E)
...
11. CyclicBarrier barrier1 = new CyclicBarrier(2, barrier1Action);
12. CyclicBarrier barrier2 = new CyclicBarrier(2, barrier2Action);

13. CyclicBarrierRunnable barrierRunnable1 =
14. new CyclicBarrierRunnable(barrier1, barrier2);

15. CyclicBarrierRunnable barrierRunnable2 =
16. new CyclicBarrierRunnable(barrier1, barrier2);

17. new Thread(barrierRunnable1).start();
18. new Thread(barrierRunnable2).start();

CyclicBarrierRunnable 类：

1. public class CyclicBarrierRunnable implements Runnable{

2. CyclicBarrier barrier1 = null;
3. CyclicBarrier barrier2 = null;

4. public CyclicBarrierRunnable(
5. CyclicBarrier barrier1,
6. CyclicBarrier barrier2) {

7. this.barrier1 = barrier1;
8. this.barrier2 = barrier2;
9. }
...
14. " waiting at barrier 1");
15. this.barrier1.await();

16. Thread.sleep(1000);
17. System.out.println(Thread.currentThread().getName() +
18. " waiting at barrier 2");
19. this.barrier2.await();
...
![0](https://note.youdao.com/yws/res/4710/953AAE3AC5C74F52AC4416952A82CA8D)
...
2. ExchangerRunnable exchangerRunnable1 =
3. new ExchangerRunnable(exchanger, "A");

4. ExchangerRunnable exchangerRunnable2 =
5. new ExchangerRunnable(exchanger, "B");

6. new Thread(exchangerRunnable1).start();
7. new Thread(exchangerRunnable2).start();

ExchangerRunnable 代码：

1. public class ExchangerRunnable implements Runnable{

2. Exchanger exchanger = null;
3. Object object = null;

4. public ExchangerRunnable(Exchanger exchanger, Object object) {
...
8. public void run() {
9. try {
10. Object previous = this.object;

11. this.object = this.exchanger.exchange(this.object);

12. System.out.println(
13. Thread.currentThread().getName() +
14. " exchanged " + previous + " for " + this.object
15. );
...
![0](https://note.youdao.com/yws/res/4709/AC3E276C05094C898F12A43642453AA4)
...
2. Set> callables = new HashSet>();

3. callables.add(new Callable() {
4. public String call() throws Exception {
5. return "Task 1";
6. }
7. });
8. callables.add(new Callable() {
...
18. List> futures = executorService.invokeAll(callables);

19. for(Future future : futures){
...
![0](https://note.youdao.com/yws/res/4711/5596119C3FB2442182D445A6C9653499)
...
12. System.out.println("result = " + scheduledFuture.get());

13. scheduledExecutorService.shutdown();
...
![0](https://note.youdao.com/yws/res/4714/FB28524740B944FF8BBE39C02B9C365B)
...
![0](https://note.youdao.com/yws/res/4713/724F46A25440449093719DB5C832BDAF)
...
4. public class MyRecursiveAction extends RecursiveAction {

5. private long workLoad = 0;

6. public MyRecursiveAction(long workLoad) {
7. this.workLoad = workLoad;
8. }

9. @Override
10. protected void compute() {

11. //if work is above threshold, break tasks up into smaller tasks
12. if(this.workLoad > 16) {
13. System.out.println("Splitting workLoad : " + this.workLoad);

14. List subtasks =
15. new ArrayList();

16. subtasks.addAll(createSubtasks());

17. for(RecursiveAction subtask : subtasks){
18. subtask.fork();
19. }

20. } else {
21. System.out.println("Doing workLoad myself: " + this.workLoad);
22. }
23. }

24. private List createSubtasks() {
25. List subtasks =
26. new ArrayList();

27. MyRecursiveAction subtask1 = new MyRecursiveAction(this.workLoad / 2);
28. MyRecursiveAction subtask2 = new MyRecursiveAction(this.workLoad / 2);

29. subtasks.add(subtask1);
30. subtasks.add(subtask2);
...
4. public class MyRecursiveTask extends RecursiveTask {

5. private long workLoad = 0;

6. public MyRecursiveTask(long workLoad) {
7. this.workLoad = workLoad;
8. }

9. protected Long compute() {

10. //if work is above threshold, break tasks up into smaller tasks
11. if(this.workLoad > 16) {
12. System.out.println("Splitting workLoad : " + this.workLoad);

13. List subtasks =
14. new ArrayList();
15. subtasks.addAll(createSubtasks());

16. for(MyRecursiveTask subtask : subtasks){
17. subtask.fork();
18. }

19. long result = 0;
20. for(MyRecursiveTask subtask : subtasks) {
21. result += subtask.join();
22. }
23. return result;

24. } else {
25. System.out.println("Doing workLoad myself: " + this.workLoad);
26. return workLoad * 3;
27. }
28. }

29. private List createSubtasks() {
30. List subtasks =
31. new ArrayList();

32. MyRecursiveTask subtask1 = new MyRecursiveTask(this.workLoad / 2);
33. MyRecursiveTask subtask2 = new MyRecursiveTask(this.workLoad / 2);

34. subtasks.add(subtask1);
35. subtasks.add(subtask2);
...
1. MyRecursiveTask myRecursiveTask = new MyRecursiveTask(128);

2. long mergedResult = forkJoinPool.invoke(myRecursiveTask);

3. System.out.println("mergedResult = " + mergedResult);
...
1. AtomicReference atomicStringReference =
2. new AtomicReference();

你也可以为泛型 AtomicReference 设置一个初始值。示例：

1. String initialReference = "the initially referenced string";
2. AtomicReference atomicStringReference =
3. new AtomicReference(initialReference);
...
2. new AtomicReference("first value referenced");
