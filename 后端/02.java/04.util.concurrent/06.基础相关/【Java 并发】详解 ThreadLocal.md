...
- [前言](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label0)
- [线程局部变量](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label1)
- [使用示例](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label2)
- [具体实现](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label3)

- [ThreadLocalMap](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label3_0)
- [副本变量存取](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label3_1)
- [ThreadLocal 散列值](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label3_2)

- [应用场景](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label4)
- [参考文章](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html#_label5)
...
public void increase() throws InterruptedException { int value = 10; Thread.sleep(10); System.out.println("increase value: " + value); }
...
public class ThreadLocalDemo { private static ThreadLocal threadLocal = new ThreadLocal<>(); private static int value = 0; public static class ThreadLocalThread implements Runnable { @Override public void run() { threadLocal.set((int)(Math.random() * 100)); value = (int) (Math.random() * 100); try { Thread.sleep(2000); } catch (InterruptedException e) { e.printStackTrace(); } System.out.printf(Thread.currentThread().getName() + ": threadLocal=%d, value=%d\n", threadLocal.get(), value); } } public static void main(String[] args) throws InterruptedException { Thread thread = new Thread(new ThreadLocalThread()); Thread thread2 = new Thread(new ThreadLocalThread()); thread.start(); thread2.start(); thread.join(); thread2.join(); } }

下面是一种可能的输出：

Thread-0: threadLocal=87, value=15 Thread-1: threadLocal=69, value=15
...
![0](https://note.youdao.com/yws/res/1470/97AE9A6A2B34499086C49C0E481B99C8)

图片来自 [http://blog.xiaohansong.com/2016/08/06/ThreadLocal-memory-leak/](http://blog.xiaohansong.com/2016/08/06/ThreadLocal-memory-leak/)
...
![0](https://note.youdao.com/yws/res/1468/EDEB8D4B87324CD5AF4EECADE4D46AEC)
...
![0](https://note.youdao.com/yws/res/1469/2AC66C47633447D5AC0211915A65F306)

图片来自 [http://faculty.cs.niu.edu/~freedman/340/340notes/340hash.htm](http://faculty.cs.niu.edu/~freedman/340/340notes/340hash.htm)
...
![0](https://note.youdao.com/yws/res/1471/4018066F79F7498BA6E49F0C8ACF0292)

图片来自 [http://alexyyek.github.io/2014/12/14/hashCollapse/](http://alexyyek.github.io/2014/12/14/hashCollapse/)
...
ThreadLocal threadLocal = new ThreadLocal() { protected Integer initialValue() { return 0; } };
...
public static void main(String[] args) { AtomicInteger hashCode = new AtomicInteger(); int hash_increment = 0x61c88647; int size = 16; List list = new ArrayList <> (); for (int i = 0; i < size; i++) { list.add(hashCode.getAndAdd(hash_increment) & (size - 1)); } System.out.println("original:" + list); Collections.sort(list); System.out.println("sort: " + list); }
...
- [http://www.jianshu.com/p/529c03d9b67e](http://www.jianshu.com/p/529c03d9b67e)
- [http://stackoverflow.com/questions/38994306/what-is-the-meaning-of-0x61c88647-constant-in-threadlocal-java](http://stackoverflow.com/questions/38994306/what-is-the-meaning-of-0x61c88647-constant-in-threadlocal-java)
- [http://jerrypeng.me/2013/06/thread-local-and-magical-0x61c88647/](http://jerrypeng.me/2013/06/thread-local-and-magical-0x61c88647/)
...
来源： [https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html](https://www.cnblogs.com/zhangjk1993/archive/2017/03/29/6641745.html)