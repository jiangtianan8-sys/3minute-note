...
||commit;|
|select id,class_name,teacher_id from class_teacher where teacher_id=1;<br><br>读到了事务B修改的数据，和第一次查询的结果不一样，是不可重读的。||
|commit;||
...
|select id,class_name,teacher_id from class_teacher where teacher_id=1;<br><br>没有读到事务B修改的数据，和第一次sql读取的一样，是可重复读的。<br><br>没有读到事务C新添加的数据。|||
|commit;|||
...
![0](https://note.youdao.com/yws/res/10625/B68F6A3CEECE4090A32396B5C29BED14)
...
![0](https://note.youdao.com/yws/res/10624/D59ED49C03744E69AE8A00F63D58739B)
