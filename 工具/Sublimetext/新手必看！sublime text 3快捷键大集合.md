sublime text 3 是 Mac os 上一款前端代码开发软件，软件体积小但运行速度快，文本编辑功能强大，还支持多种编程语言，非常多的插件可以安装，是一款非常优秀的代码编辑软件。今天小编为大家总结整理了 sublime text 3 的快捷键，让您的工作效率事半功倍！

[新手必看！sublime text 3快捷键大集合​www.macw.com/news/494.html](https://link.zhihu.com/?target=https%3A//www.macw.com/news/494.html)

![](assets/新手必看！sublime%20text%203快捷键大集合/file-20251121093632733.png)

![](assets/新手必看！sublime%20text%203快捷键大集合/file-20251121093643543.png)
...
- Ctrl+J 合并选中的多行代码为一行。例如：将多行格式的 CSS 属性合并为一行。
...
- Ctrl+G 打开搜索框，自动带：，输入数字跳转到该行代码。例如：在页面代码比较长的文件中快速定位。
- Ctrl+R 打开搜索框，自动带@，输入关键字，查找文件中的函数名。例如：在函数较多的页面快速查找某个函数。
...
- -Alt+Shift+(数字)：分屏显示
- Alt+ 数字：切换打开第 N 个文件
- Shift+ 右键拖动：光标多不，用来更改或插入列内容鼠标的前进后退键可切换 Tab 文件
- 按 Ctrl，依次点击或选取，可需要编辑的多个位置

以上是小编为大家带来的 sublime text 3 快捷键集合，希望对您有所帮助。
