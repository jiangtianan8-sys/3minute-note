sublime text 3是Mac os上一款前端代码开发软件，软件体积小但运行速度快，文本编辑功能强大，还支持多种编程语言，非常多的插件可以安装，是一款非常优秀的代码编辑软件。今天小编为大家总结整理了sublime text 3的快捷键，让您的工作效率事半功倍！
...
以上是小编为大家带来的sublime text 3快捷键集合，希望对您有所帮助。